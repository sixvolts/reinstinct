...
void mmq_gemm_q4k_repacked_f32(const unsigned char* __restrict__ wbase,
                               ...
                               unsigned int p_rows)
{
    mmq_q4k_impl<4, 4, 4, 16, 256>(wbase, xq, y, in_dim, out_dim, p_rows);
}
...
void mmq_gemm_q4k_repacked_narrow_f32(const unsigned char* __restrict__ wbase,
                               ...
                               unsigned int p_rows)
{
    mmq_q4k_impl<NARROW_TM, NARROW_TN, NARROW_BK, NARROW_TXG, NARROW_THREADS>(wbase, xq, y, in_dim, out_dim, p_rows);
}
