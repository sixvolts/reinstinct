// Grouped MoE expert matvec — one expert, its routed tokens via idx[].
...
extern "C" __global__
void moe_matvec_grouped_q8_0_f32(const unsigned char* __restrict__ slab,
