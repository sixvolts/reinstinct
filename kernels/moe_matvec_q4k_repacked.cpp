// MoE expert matvec — repacked Q4_K, dp4a. Body is matvec_q4k_repacked's
// with the expert-indexing prologue of moe_matvec_q6k_repacked: grid.y
// selects the expert slot, the id comes from the device `ids` buffer.
//
...
extern "C" __global__
void moe_matvec_q4k_repacked_f32(const unsigned char* __restrict__ slab,
