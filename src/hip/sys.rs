...
pub struct Hip {
    ...
    pub get_device:          unsafe extern "C" fn(*mut i32) -> HipError,
    pub device_can_access_peer:    unsafe extern "C" fn(*mut i32, i32, i32) -> HipError,
    pub device_enable_peer_access: unsafe extern "C" fn(i32, u32) -> HipError,
    ...
    pub memcpy_peer_async:   unsafe extern "C" fn(*mut c_void, i32, *const c_void, i32, usize, HipStream) -> HipError,
    ...
    pub stream_wait_event:   unsafe extern "C" fn(HipStream, HipEvent, u32) -> HipError,
...
pub fn hip() -> Result<&'static Hip, &'static str> {
    let cell = HIP.get_or_init(|| unsafe {
        ...
        Ok(Hip {
            ...
            get_device:           sym!(b"hipGetDevice"),
            device_can_access_peer:    sym!(b"hipDeviceCanAccessPeer"),
            device_enable_peer_access: sym!(b"hipDeviceEnablePeerAccess"),
